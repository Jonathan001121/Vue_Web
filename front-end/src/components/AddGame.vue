  ...
  <div>
    ...
    <form class="container">
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-10">
          <input class="form-control" type="number" v-model="game.quantity" placeholder="quantity" />
        </div>
      </div>
      ...
      <button class="btn btn-primary" type="submit" @click="insertGame()">
        Save
      </button>
    </form>
  </div>
...
export default {
  ...
  setup() {
    ...
    const insertGame = async function () {
